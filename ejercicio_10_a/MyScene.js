...
class MyScene extends THREE.Scene {
	...
	creaEjes() {
		this.axis = new THREE.AxesHelper(104);
	...
	createGround() {
		...
		var geometryGround = new THREE.SphereGeometry(105, 64, 64);
		

		// El material se hará con una textura de madera
		var texture = new THREE.TextureLoader().load('../../imgs/galaxy.jpg');
	...
	createLights() {
		...
		this.spotLight.position.set(0, 20, 500);
