...
class Trebol extends THREE.Object3D {
  ...
  createShape() {
    ...
    shape.moveTo(0, 0);
    shape.bezierCurveTo(6, -10, 15, 3, 5, 5); //Va cogiendo de puntos en 2D
    shape.bezierCurveTo(7, 17, -9, 15, -5, 5); //Va cogiendo de puntos en 2D
    shape.bezierCurveTo(-15, 5, -8, -10, 0, 0); //Va cogiendo de puntos en 2D
