...
class MyScene extends THREE.Scene {
  constructor(myCanvas) {
    ...
    this.barrido = new Barrido(this.gui, "Barrido");
    this.corazon = new Corazon(this.gui, "Corazon");
    this.rombo = new Rombo(this.gui, "Rombo");
    this.trebol = new Trebol(this.gui, "Trebol");
    this.pikas = new Pikas(this.gui, "Pikas");
  ...
  createLights() {
    ...
    this.spotLight.position.set(0, 0, 180);
